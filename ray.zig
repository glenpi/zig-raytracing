...
pub const Ray = struct {
    ...
    // t=1 is one direction-vector's length further along. hittable.zig's
    // Sphere.hit() solves for the t of the intersection point, then calls
    // this to get the actual 3D coordinates.
